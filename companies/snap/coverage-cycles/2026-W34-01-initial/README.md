...
# Snap coverage cycle 01 — 2026-W34 — initial

> This manifest points to the one canonical report, valuation, decision, and supporting evidence for Snap's first coverage cycle. Working drafts evolved during research but are not separate reader-facing records. Git history preserves their development.

## Cycle contract

| Field | Value |
| --- | --- |
| Cycle ID | `SNAP-2026-W34-01` |
| ISO week | `2026-W34` |
...
While this cycle remains a draft, later evidence updates its canonical report and supporting model in place. Once finalized, a materially new thesis or valuation—especially after third-quarter results—must start `SNAP-<ISO-week>-02-revaluation`, link back to this manifest, and compare the two final cycle reports rather than same-cycle working drafts.

## Next review

Review after Snap's third-quarter 2026 results and no later than 15 November 2026. If cycle 01 is still an active draft, integrate the evidence here. If it has been finalized, create coverage cycle 02 for a new report or valuation.
