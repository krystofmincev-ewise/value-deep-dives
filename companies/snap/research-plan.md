...
Determine whether Snap offers an attractive risk-adjusted return at the eventual reference price, with particular attention to advertising-system progress, user durability, cash economics, dilution, and downside survival.
...
- Segment the roles of messaging, Stories, Spotlight, Maps, lenses, and subscriptions.
- Examine cohort, geography, age, engagement, retention, and creator dynamics where public evidence permits.
- Identify where product use creates monetizable intent and where engagement may remain structurally difficult to monetize.

### 3. Advertising system

- Map advertiser onboarding, objective selection, creative tools, targeting, retrieval, ranking, auction, pacing, measurement, and feedback loops.
- Distinguish management claims from reported advertiser or revenue evidence.
- Compare Snap's publicly visible capabilities with Meta, TikTok, Pinterest, Reddit, and relevant ad-tech peers.
- Identify constraints imposed by signal loss, privacy rules, data scale, compute, and auction liquidity.

### 4. Management and capital allocation

- Review Evan Spiegel's product and strategic record, communication, incentives, voting control, and willingness to change direction.
- Study executive turnover, compensation, stock-based compensation, acquisitions, buybacks, and infrastructure commitments.
- Triangulate founder interviews against filings and subsequent outcomes.
...
- Define measurable thesis breakers before publication.
- Identify leading indicators and a review cadence.
- Record what evidence would move confidence up or down without relying on the share price.
