...
The single canonical valuation for coverage cycle `SNAP-2026-W34-01` is [2026-W34](2026-W34-valuation.md). It produces a 12-month bear/base/bull range of **$2.50 / $7.75 / $14.25** and a probability-weighted value of **$7.74** from a $5.21 public reference. Its six-month checkpoint range is **$3.70 / $6.73 / $10.81**, weighted to **$6.79**.

This valuation is not registered in the prospective ledger pending formal price-record and publication controls.
