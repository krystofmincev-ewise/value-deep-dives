...
The single canonical valuation for coverage cycle `SNAP-2026-W34-01` is [2026-W34](2026-W34-valuation.md). Its deterministic 100,000-draw joint model produces a six-month **P10 / P50 / P90 of $3.81 / $6.77 / $10.64** and a **mean of $7.09**, leading to a twelve-month **$2.86 / $7.90 / $13.78** and **$8.23 mean** from a $5.21 public reference. The modeled probabilities below the reference are 28.5% and 28.6%. Six- and twelve-month fair values have 0.81 correlation because revenue, valuation, capital, dilution, and the legal branch are linked inside every draw; neither horizon is a market-price convergence forecast.
