...
The decision begins at the current market price. Portfolio history is isolated from valuation. For conflict disclosure, the repository owner reported holdings of roughly 4% in WIX and 8% in SNAP as of 30 August 2026. The first Wix stake was purchased around 29 June 2026—approximately two weeks before the [13 July 2026 CEO interview on 20VC](https://www.youtube.com/watch?v=TdQyVXN0GF8)—and the position was increased on or shortly after 13 July, immediately after reviewing the interview. The dates, weights and sequence are user-reported rather than broker-verified and do not enter the research assumptions. See the [position-history record](disclosures/2026-08-30-user-reported-position-history.md).
